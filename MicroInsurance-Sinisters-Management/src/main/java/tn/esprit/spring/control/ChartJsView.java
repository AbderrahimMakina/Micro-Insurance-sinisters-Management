...
public class ChartJsView implements Serializable {
    ...
    public void createLineModel() {
        ...
        dataSet.setLabel("statistic charge sinistre par ville ");
    ...
    public void createBarModel() {
        ...
        barDataSet.setLabel("Statistics Charge de sinistre par ville");
        List<Sinister> devMen = IsinisterService.retrieveAllSinisters();
        List<Number> values = new ArrayList<>();
        for (Sinister deliveryMen: devMen){
         values.add(deliveryMen.getChargeSinister());
        }
        ...
        labels.add(deliveryMen.getSinisterPlace());
        }
       data.setLabels(labels);
    ...
    public void createBarModel2() {
        ...
        BarChartDataSet barDataSet = new BarChartDataSet();
        barDataSet.setLabel("statistic charge sinistre par ville");
    ...
    public void createHorizontalBarModel() {
        ...
        hbarDataSet.setLabel("statistic charge sinistre par ville");
    ...
    public void createRadarModel() {
        ...
        radarDataSet.setLabel("statistic charge sinistre par ville");
    ...
    public void createDonutModel() {
        ...
        List<Number> values = new ArrayList<>();
        values.add(contractRep.count());
        values.add(sinisterRep.count());
        values.add(insuredRep.count());
        dataSet.setData(values);
        ...
        data.addChartDataSet(dataSet);
        List<String> labels = new ArrayList<>();
        labels.add("contracts");
        labels.add("sinisters");
        labels.add("insureds");
        data.setLabels(labels);
